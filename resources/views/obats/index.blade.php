    ...
    <div id="filterModal" class="modal z-50">
            <div class="modal-content bg-white p-6 rounded-lg shadow-lg max-w-md mx-auto my-auto">
                ...
                <form action="{{ route('obat.index') }}" method="GET">
                    <div class="mb-4">
                        <label class="block text-slate-600 text-sm font-medium mb-2" for="kadaluarsa">
                            Tanggal Kadaluarsa
                        </label>
                        <input type="date" name="kadaluarsa" id="kadalursa" 
    ...
    <table class="min-w-full bg-white border border-gray-200 rounded-lg shadow">
        <thead>
            <tr class="bg-gray-100 border-black">
                <th class="px-6 py-3 text-left text-gray-600 font-medium">Nama Obat</th>
                <th class="px-6 py-3 text-left text-gray-600 font-medium">Kegunaan</th>
                <th class="px-6 py-3 text-left text-gray-600 font-medium">Stok</th>
                <th class="px-6 py-3 text-left text-gray-600 font-medium">Tanggal Kadaluarsa</th>
                <th class="px-6 py-3 text-left text-gray-600 font-medium w-1">Aksi</th>
            </tr>
        </thead>
        <tbody id="obatTableBody" class="divide-y divide-gray-200">
